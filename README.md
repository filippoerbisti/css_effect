<h1 align="center">
  Some cool code w/ JS & CSS Animated Effects 🦋
</h1>
...
<div align="center">
  <h4>
    <a href="https://github.com/filippoerbisti/css_effect/stargazers"><img src="https://img.shields.io/github/stars/filippoerbisti/css_effect.svg?style=plasticr"/></a>
        <a href="https://github.com/filippoerbisti/css_effect/commits/master"><img src="https://img.shields.io/github/last-commit/filippoerbisti/css_effect.svg?style=plasticr"/></a>
            <a href="https://github.com/filippoerbisti/css_effect/commits/master"><img src="https://img.shields.io/github/commit-activity/y/filippoerbisti/css_effect.svg?style=plasticr"/></a>
  </h4>
  <h4>
    Check my branches and have fun!
    <br/>
    View <a href="https://codepen.io/filippoerbisti">DEMOS</a> on Codepen.
  </h4>
</div>
...
<details open="open">
  ...
  - [Loader](#loader)
    ...
    - [Glowing Gradient Loader Ring Animation Effects](#glowing-gradient-loader-ring-animation-effects)
  - [Button](#button)
    - [Animated Popup Box](#animated-popup-box)
    - [3D Flip Checkbox Animation Effects](#3d-flip-checkbox-animation-effects)
    - [Neon Light Button Animation on Hover](#neon-light-button-animation-on-hover)
    - [Neon Light Button Animation Effects](#neon-light-button-animation-effects)
  - [Dark Mode](#dark-mode)
    - [Dark Mode CSS](#dark-mode-css)
  - [Figure](#figure)
    - [Expanding Flex Cards CSS](#expanding-flex-cards-css)
    - [Animated Eyes Follow Mouse Cursor](#animated-eyes-follow-mouse-cursor)
    - [Hex Circle Follow on Mouse](#hex-circle-follow-on-mouse)
    - [Rainy Cloud Animation](#rainy-cloud-animation)
    - [Endless Road Animation Effects](#endless-road-animation)
    - [Ambient Light Effects](#ambient-light-effects)
    - [Swing Figure CSS Animation](#swing-figure-css-animation)
    - [Background Parallax Effect on Mouse Cursor](#background-parallax-effect-on-mouse-cursor)
  - [Text](#text)
...
## [MENU](https://codepen.io/collection/gYmVJM)
...
## [LOADER](https://codepen.io/collection/RzpEmx)
...
## [BUTTON](https://codepen.io/collection/mrWNYE)
...
## [DARK MODE](https://codepen.io/collection/vBxowW)
...
## [FIGURE](https://codepen.io/collection/GoWVax)
...
## [TEXT](https://codepen.io/collection/LPWwoW)
...
>Follow me on [Codepen](https://codepen.io/filippoerbisti) 👍
